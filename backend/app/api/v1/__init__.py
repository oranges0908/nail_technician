...
from app.api.v1 import auth, users, health, system, services, uploads, customers, inspirations, designs, abilities, conversations
...
api_router.include_router(conversations.router, prefix="/conversations", tags=["AI 对话助理"])
